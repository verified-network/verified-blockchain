...
#define SWIGTYPE_p_dht__InfoHash swig_types[2]
#define SWIGTYPE_p_dht__crypto__PublicKey swig_types[3]
...
#define SWIGV8_INIT verified_initialize


SWIGV8_ClientData _exports_peer_clientData;


static void _wrap_peer_logged_set(v8::Local<v8::String> property, v8::Local<v8::Value> value,
  const SwigV8PropertyCallbackInfoVoid &info) {
  SWIGV8_HANDLESCOPE();
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "peer_logged_set" "', argument " "1"" of type '" "bool""'");
  } 
  arg1 = (bool)(val1);
  peer::logged = arg1;
...
static SwigV8ReturnValue _wrap_peer_logged_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  bool result;
  
  result = (bool)peer::logged;
...
static void _wrap_peer_public_key_set(v8::Local<v8::String> property, v8::Local<v8::Value> value,
  const SwigV8PropertyCallbackInfoVoid &info) {
  SWIGV8_HANDLESCOPE();
  
  dht::crypto::PublicKey arg1 ;
  void *argp1 ;
  int res1 = 0 ;
  
  {
    res1 = SWIG_ConvertPtr(value, &argp1, SWIGTYPE_p_dht__crypto__PublicKey,  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "peer_public_key_set" "', argument " "1"" of type '" "dht::crypto::PublicKey""'"); 
    }  
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "peer_public_key_set" "', argument " "1"" of type '" "dht::crypto::PublicKey""'");
    } else {
      arg1 = *((dht::crypto::PublicKey *)(argp1));
    }
  }
  peer::public_key = arg1;
...
static SwigV8ReturnValue _wrap_peer_public_key_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  dht::crypto::PublicKey result;
  
  result = peer::public_key;
  jsresult = SWIG_NewPointerObj((new dht::crypto::PublicKey((const dht::crypto::PublicKey&)(result))), SWIGTYPE_p_dht__crypto__PublicKey, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_peer_signup(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_peer_signup.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_peer, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_peer_signin(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_peer_signin.");
  ...
  jsresult = SWIG_NewPointerObj((new dht::InfoHash((const dht::InfoHash&)(result))), SWIGTYPE_p_dht__InfoHash, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_peer_signout(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_peer_signout.");
...
static SwigV8ReturnValue _wrap_new_peer(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Object> self = args.Holder();
  peer *result;
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_peer.");
  result = (peer *)new peer();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_peer, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031710)
static void _wrap_delete_peer(v8::Persistent<v8::Value> object, void *parameter) {
  SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031900)
  static void _wrap_delete_peer(v8::Isolate *isolate, v8::Persistent<v8::Value> object, void *parameter) {
    SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < SWIGV8_SETWEAK_VERSION)
    static void _wrap_delete_peer(v8::Isolate *isolate, v8::Persistent< v8::Object> *object, SWIGV8_Proxy *proxy) {
#else
      static void _wrap_delete_peer(const v8::WeakCallbackData<v8::Object, SWIGV8_Proxy> &data) {
        v8::Local<v8::Object> object = data.GetValue();
        SWIGV8_Proxy *proxy = data.GetParameter();
#endif
        
        if(proxy->swigCMemOwn && proxy->swigCObject) {
          peer * arg1 = (peer *)proxy->swigCObject;
          delete arg1;
        }
        delete proxy;
...
static SwigV8ReturnValue _wrap_signup(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_signup.");
  
  res1 = SWIG_ConvertPtr(args[0], &argp1, SWIGTYPE_p_string,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "signup" "', argument " "1"" of type '" "string &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "signup" "', argument " "1"" of type '" "string &""'"); 
  }
  arg1 = (string *)(argp1);
  res2 = SWIG_ConvertPtr(args[1], &argp2, SWIGTYPE_p_string,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "signup" "', argument " "2"" of type '" "string &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "signup" "', argument " "2"" of type '" "string &""'"); 
  }
  arg2 = (string *)(argp2);
  result = (int)signup(*arg1,*arg2);
  jsresult = SWIG_From_int((int)(result));
...
static SwigV8ReturnValue _wrap_signin(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_signin.");
  
  res1 = SWIG_ConvertPtr(args[0], &argp1, SWIGTYPE_p_string,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "signin" "', argument " "1"" of type '" "string &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "signin" "', argument " "1"" of type '" "string &""'"); 
  }
  arg1 = (string *)(argp1);
  res2 = SWIG_ConvertPtr(args[1], &argp2, SWIGTYPE_p_string,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "signin" "', argument " "2"" of type '" "string &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "signin" "', argument " "2"" of type '" "string &""'"); 
  }
  arg2 = (string *)(argp2);
  result = (int)signin(*arg1,*arg2);
  jsresult = SWIG_From_int((int)(result));
...
static SwigV8ReturnValue _wrap_signout(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  int result;
  
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_signout.");
...
static swig_type_info _swigt__p_dht__InfoHash = {"_p_dht__InfoHash", "dht::InfoHash *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_dht__crypto__PublicKey = {"_p_dht__crypto__PublicKey", "dht::crypto::PublicKey *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p___int64,
  &_swigt__p_char,
  &_swigt__p_dht__InfoHash,
  &_swigt__p_dht__crypto__PublicKey,
  &_swigt__p_float,
  &_swigt__p_int,
  &_swigt__p_long,
  &_swigt__p_p_char,
...
static swig_cast_info _swigc__p_dht__InfoHash[] = {  {&_swigt__p_dht__InfoHash, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_dht__crypto__PublicKey[] = {  {&_swigt__p_dht__crypto__PublicKey, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p___int64,
  _swigc__p_char,
  _swigc__p_dht__InfoHash,
  _swigc__p_dht__crypto__PublicKey,
  _swigc__p_float,
  _swigc__p_int,
  _swigc__p_long,
  _swigc__p_p_char,
...
#endif
{
  ...
  /* Name: _exports_peer, Type: p_peer, Dtor: _wrap_delete_peer */
v8::Handle<v8::FunctionTemplate> _exports_peer_class = SWIGV8_CreateClassTemplate("_exports_peer");
SWIGV8_SET_CLASS_TEMPL(_exports_peer_clientData.class_templ, _exports_peer_class);
_exports_peer_clientData.dtor = _wrap_delete_peer;
if (SWIGTYPE_p_peer->clientdata == 0) {
  SWIGTYPE_p_peer->clientdata = &_exports_peer_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_peer_class, "signup", _wrap_peer_signup);
SWIGV8_AddMemberFunction(_exports_peer_class, "signin", _wrap_peer_signin);
SWIGV8_AddMemberFunction(_exports_peer_class, "signout", _wrap_peer_signout);
  ...
  /* class instances */
  /* Class: peer (_exports_peer) */
v8::Handle<v8::FunctionTemplate> _exports_peer_class_0 = SWIGV8_CreateClassTemplate("peer");
_exports_peer_class_0->SetCallHandler(_wrap_new_peer);
_exports_peer_class_0->Inherit(_exports_peer_class);
_exports_peer_class_0->SetHiddenPrototype(true);
v8::Handle<v8::Object> _exports_peer_obj = _exports_peer_class_0->GetFunction();


  /* add static class functions and variables */
  SWIGV8_AddStaticVariable(_exports_peer_obj, "logged", _wrap_peer_logged_get, _wrap_peer_logged_set);
SWIGV8_AddStaticVariable(_exports_peer_obj, "public_key", _wrap_peer_public_key_get, _wrap_peer_public_key_set);
SWIGV8_AddStaticFunction(exports_obj, "signup", _wrap_signup);
SWIGV8_AddStaticFunction(exports_obj, "signin", _wrap_signin);
SWIGV8_AddStaticFunction(exports_obj, "signout", _wrap_signout);


  /* register classes */
  exports_obj->Set(SWIGV8_SYMBOL_NEW("peer"), _exports_peer_obj);
...
NODE_MODULE(verified, verified_initialize)
#endif
