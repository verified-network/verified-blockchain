...
extern "C" {
#endif
SWIGINTERN int Swig_var_peer_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_class,  0 );
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""peer""' of type '""class""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""peer""' of type '""class""'");
    } else {
      peer = *((class *)(argp));
    }
  }
...
SWIGINTERN PyObject *Swig_var_peer_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&peer), SWIGTYPE_p_class,  0 );
  return pyobj;
}


SWIGINTERN PyObject *_wrap_signup(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:signup",&obj0,&obj1)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_signin(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  string *arg1 = 0 ;
  string *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:signin",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_string,  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_signout(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)":signout")) SWIG_fail;
  result = (int)signout();
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
fail:
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"signup", _wrap_signup, METH_VARARGS, NULL},
	 { (char *)"signin", _wrap_signin, METH_VARARGS, NULL},
	 { (char *)"signout", _wrap_signout, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
# endif
  ...
  SWIG_addvarlink(SWIG_globals(),(char *)"peer",Swig_var_peer_get, Swig_var_peer_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
