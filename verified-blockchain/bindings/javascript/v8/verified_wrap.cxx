...
SWIGV8_ClientData _exports_client_clientData;
...
static SwigV8ReturnValue _wrap_client_handleOutboundRequest(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_client_handleOutboundRequest.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_client, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "client_handleOutboundRequest" "', argument " "1"" of type '" "client *""'"); 
  }
  arg1 = (client *)(argp1);
  res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_client__request,  0 );
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_client_handleInboundResponse(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_client_handleInboundResponse.");
...
static SwigV8ReturnValue _wrap_new_client(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Object> self = args.Holder();
  client *result;
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_client.");
  result = (client *)new client();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_client, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031710)
static void _wrap_delete_client(v8::Persistent<v8::Value> object, void *parameter) {
  SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031900)
  static void _wrap_delete_client(v8::Isolate *isolate, v8::Persistent<v8::Value> object, void *parameter) {
    SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < SWIGV8_SETWEAK_VERSION)
    static void _wrap_delete_client(v8::Isolate *isolate, v8::Persistent< v8::Object> *object, SWIGV8_Proxy *proxy) {
#else
      static void _wrap_delete_client(const v8::WeakCallbackData<v8::Object, SWIGV8_Proxy> &data) {
        v8::Local<v8::Object> object = data.GetValue();
        SWIGV8_Proxy *proxy = data.GetParameter();
#endif
        
        if(proxy->swigCMemOwn && proxy->swigCObject) {
          client * arg1 = (client *)proxy->swigCObject;
          delete arg1;
        }
        delete proxy;
...
/* Name: _exports_client, Type: p_client, Dtor: _wrap_delete_client */
v8::Handle<v8::FunctionTemplate> _exports_client_class = SWIGV8_CreateClassTemplate("_exports_client");
SWIGV8_SET_CLASS_TEMPL(_exports_client_clientData.class_templ, _exports_client_class);
_exports_client_clientData.dtor = _wrap_delete_client;
if (SWIGTYPE_p_client->clientdata == 0) {
  SWIGTYPE_p_client->clientdata = &_exports_client_clientData;
}
...
SWIGV8_AddMemberFunction(_exports_client_class, "handleOutboundRequest", _wrap_client_handleOutboundRequest);
SWIGV8_AddMemberFunction(_exports_client_class, "handleInboundResponse", _wrap_client_handleInboundResponse);
...
/* Class: client (_exports_client) */
v8::Handle<v8::FunctionTemplate> _exports_client_class_0 = SWIGV8_CreateClassTemplate("client");
_exports_client_class_0->SetCallHandler(_wrap_new_client);
_exports_client_class_0->Inherit(_exports_client_class);
_exports_client_class_0->SetHiddenPrototype(true);
v8::Handle<v8::Object> _exports_client_obj = _exports_client_class_0->GetFunction();
...
exports_obj->Set(SWIGV8_SYMBOL_NEW("client"), _exports_client_obj);
