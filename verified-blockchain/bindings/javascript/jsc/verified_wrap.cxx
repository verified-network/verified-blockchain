...
#define SWIGTYPE_p_client swig_types[2]
#define SWIGTYPE_p_client__request swig_types[3]
...
#define SWIGTYPE_p_peer swig_types[9]
...
#define SWIGJSC_INIT verified_initialize
...
static JSClassDefinition _exports_peer_classDefinition;

static JSClassDefinition _exports_peer_objectDefinition;

static JSClassRef _exports_peer_classRef;


static JSValueRef _wrap_peer_signup(JSContextRef context, JSObjectRef function, JSObjectRef thisObject, size_t argc, const JSValueRef argv[], JSValueRef* exception)
{
  peer *arg1 = (peer *) 0 ;
  std::string *arg2 = 0 ;
  std::string *arg3 = 0 ;
  ...
  if(argc != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_peer_signup.");
  
  res1 = SWIG_ConvertPtr(thisObject, &argp1,SWIGTYPE_p_peer, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "peer_signup" "', argument " "1"" of type '" "peer *""'"); 
  }
  arg1 = (peer *)(argp1);
  res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_std__string,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "peer_signup" "', argument " "2"" of type '" "std::string &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "peer_signup" "', argument " "2"" of type '" "std::string &""'"); 
  }
  arg2 = (std::string *)(argp2);
  res3 = SWIG_ConvertPtr(argv[1], &argp3, SWIGTYPE_p_std__string,  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "peer_signup" "', argument " "3"" of type '" "std::string &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "peer_signup" "', argument " "3"" of type '" "std::string &""'"); 
  }
...
static JSValueRef _wrap_peer_signin(JSContextRef context, JSObjectRef function, JSObjectRef thisObject, size_t argc, const JSValueRef argv[], JSValueRef* exception)
{
  peer *arg1 = (peer *) 0 ;
  std::string *arg2 = 0 ;
  std::string *arg3 = 0 ;
  ...
  if(argc != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_peer_signin.");
  
  res1 = SWIG_ConvertPtr(thisObject, &argp1,SWIGTYPE_p_peer, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "peer_signin" "', argument " "1"" of type '" "peer *""'"); 
  }
  arg1 = (peer *)(argp1);
  res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_std__string,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "peer_signin" "', argument " "2"" of type '" "std::string &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "peer_signin" "', argument " "2"" of type '" "std::string &""'"); 
  }
  arg2 = (std::string *)(argp2);
  res3 = SWIG_ConvertPtr(argv[1], &argp3, SWIGTYPE_p_std__string,  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "peer_signin" "', argument " "3"" of type '" "std::string &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "peer_signin" "', argument " "3"" of type '" "std::string &""'"); 
  }
  arg3 = (std::string *)(argp3);
...
static JSValueRef _wrap_peer_signout(JSContextRef context, JSObjectRef function, JSObjectRef thisObject, size_t argc, const JSValueRef argv[], JSValueRef* exception)
{
  peer *arg1 = (peer *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if(argc != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_peer_signout.");
  
  res1 = SWIG_ConvertPtr(thisObject, &argp1,SWIGTYPE_p_peer, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "peer_signout" "', argument " "1"" of type '" "peer *""'"); 
  }
  arg1 = (peer *)(argp1);
...
static JSObjectRef _wrap_new_peer(JSContextRef context, JSObjectRef thisObject, size_t argc, const JSValueRef argv[], JSValueRef* exception)
{
  peer *result;
  if(argc != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_peer.");
  
  result = (peer *)new peer();
  
  
  return SWIG_JSC_NewPointerObj(context, result, SWIGTYPE_p_peer, SWIG_POINTER_OWN);
  goto fail;
fail:
  return NULL;
}
...
static void _wrap_delete_peer(JSObjectRef thisObject)
{
  SwigPrivData* t = (SwigPrivData*) JSObjectGetPrivate(thisObject);
  if(t) {
    if (t->swigCMemOwn) {
      peer * arg1 = (peer *)t->swigCObject;
      delete arg1;
    }
...
static JSStaticValue _exports_peer_staticValues[] = {
  {
    0, 0, 0, 0 
  }
};

static JSStaticFunction _exports_peer_staticFunctions[] = {
  {
    0, 0, 0 
  }
};

static JSStaticValue _exports_peer_values[] = {
  {
    0, 0, 0, 0 
  }
};

static JSStaticFunction _exports_peer_functions[] = {
  {
    "signup", _wrap_peer_signup, kJSPropertyAttributeNone
  },
  
  
  {
    "signin", _wrap_peer_signin, kJSPropertyAttributeNone
  },
  
  
  {
    "signout", _wrap_peer_signout, kJSPropertyAttributeNone
  },
...
static JSClassDefinition _exports_client_classDefinition;

static JSClassDefinition _exports_client_objectDefinition;

static JSClassRef _exports_client_classRef;


static JSValueRef _wrap_client_handleOutboundRequest(JSContextRef context, JSObjectRef function, JSObjectRef thisObject, size_t argc, const JSValueRef argv[], JSValueRef* exception)
{
  ...
  if(argc != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_client_handleOutboundRequest.");
  
  res1 = SWIG_ConvertPtr(thisObject, &argp1,SWIGTYPE_p_client, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "client_handleOutboundRequest" "', argument " "1"" of type '" "client *""'"); 
  }
  arg1 = (client *)(argp1);
  res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_client__request,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "client_handleOutboundRequest" "', argument " "2"" of type '" "client::request &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "client_handleOutboundRequest" "', argument " "2"" of type '" "client::request &""'"); 
  }
  arg2 = (client::request *)(argp2);
...
static JSValueRef _wrap_client_handleInboundResponse(JSContextRef context, JSObjectRef function, JSObjectRef thisObject, size_t argc, const JSValueRef argv[], JSValueRef* exception)
{
  client *arg1 = (client *) 0 ;
  client::request *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if(argc != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_client_handleInboundResponse.");
  
  res1 = SWIG_ConvertPtr(thisObject, &argp1,SWIGTYPE_p_client, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "client_handleInboundResponse" "', argument " "1"" of type '" "client *""'"); 
  }
  arg1 = (client *)(argp1);
  res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_client__request,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "client_handleInboundResponse" "', argument " "2"" of type '" "client::request &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "client_handleInboundResponse" "', argument " "2"" of type '" "client::request &""'"); 
  }
  arg2 = (client::request *)(argp2);
...
static JSObjectRef _wrap_new_client(JSContextRef context, JSObjectRef thisObject, size_t argc, const JSValueRef argv[], JSValueRef* exception)
{
  client *result;
  if(argc != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_client.");
  
  result = (client *)new client();
  
  
  return SWIG_JSC_NewPointerObj(context, result, SWIGTYPE_p_client, SWIG_POINTER_OWN);
  goto fail;
fail:
  return NULL;
}
...
static void _wrap_delete_client(JSObjectRef thisObject)
{
  SwigPrivData* t = (SwigPrivData*) JSObjectGetPrivate(thisObject);
  if(t) {
    if (t->swigCMemOwn) {
      client * arg1 = (client *)t->swigCObject;
      delete arg1;
    }
    /* remove the private data to make sure that it isn't accessed elsewhere */
    JSObjectSetPrivate(thisObject, NULL);
...
static JSStaticValue _exports_client_staticValues[] = {
  {
    0, 0, 0, 0 
  }
};

static JSStaticFunction _exports_client_staticFunctions[] = {
  {
    0, 0, 0 
  }
};

static JSStaticValue _exports_client_values[] = {
  {
    0, 0, 0, 0 
  }
};

static JSStaticFunction _exports_client_functions[] = {
  {
    "handleOutboundRequest", _wrap_client_handleOutboundRequest, kJSPropertyAttributeNone
  },
  
  
  {
    "handleInboundResponse", _wrap_client_handleInboundResponse, kJSPropertyAttributeNone
  },
...
static swig_type_info _swigt__p_client = {"_p_client", "client *|p_client", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_client__request = {"_p_client__request", "client::request *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_peer = {"_p_peer", "peer *|p_peer", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_client__request[] = {  {&_swigt__p_client__request, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_peer[] = {  {&_swigt__p_peer, 0, 0, 0},{0, 0, 0, 0}};
...
_exports_peer_classDefinition.staticFunctions = _exports_peer_staticFunctions;
_exports_peer_classDefinition.staticValues = _exports_peer_staticValues;
_exports_peer_classDefinition.callAsConstructor = _wrap_new_peer;
_exports_peer_objectDefinition.finalize = _wrap_delete_peer;
_exports_peer_objectDefinition.staticValues = _exports_peer_values;
_exports_peer_objectDefinition.staticFunctions = _exports_peer_functions;

_exports_peer_objectDefinition.parentClass = _SwigObject_classRef;


_exports_peer_classRef = JSClassCreate(&_exports_peer_objectDefinition);
SWIGTYPE_p_peer->clientdata = _exports_peer_classRef;


JS_registerClass(context, exports_object, "peer", &_exports_peer_classDefinition);


_exports_client_classDefinition.staticFunctions = _exports_client_staticFunctions;
_exports_client_classDefinition.staticValues = _exports_client_staticValues;
_exports_client_classDefinition.callAsConstructor = _wrap_new_client;
_exports_client_objectDefinition.finalize = _wrap_delete_client;
_exports_client_objectDefinition.staticValues = _exports_client_values;
_exports_client_objectDefinition.staticFunctions = _exports_client_functions;

_exports_client_objectDefinition.parentClass = _SwigObject_classRef;


_exports_client_classRef = JSClassCreate(&_exports_client_objectDefinition);
SWIGTYPE_p_client->clientdata = _exports_client_classRef;


JS_registerClass(context, exports_object, "client", &_exports_client_classDefinition);
